...
export default class PwShowLayoutButton extends HTMLElement {
  ...
  onClick(evt) {
    H.emitEvent(true, true, '', 'show-layout-modal-up', this);
    evt.stopPropagation();
  }
  ...
  get style() {
    return `<style>
              ...
              .social-button.pinterest-button {
                background: url("https://cdn4.iconfinder.com/data/icons/48-bubbles/48/14.News-128.png") no-repeat center;
              }
...
if (!window.customElements.get('pw-show-layout-button')) {
  document.registerElement('pw-show-layout-button', PwShowLayoutButton);
}
